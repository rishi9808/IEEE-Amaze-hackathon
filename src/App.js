            ...
            <div className="intro-wrap">
                ...
                <div className="intro">
                    ...
                    <p>
                        <strong>
                            <em>
                            Programming is a skill best aquired by practice & example
                        ...
                        <strong>Amaze '23</strong>🏮✨<br />
                        A chance to exhibit your skills, have fun, and compete to come out
                        victorious! Amaze '23 has an alluring prize pool of ₹15,000✨<br />
                        <br />
                        📅Date : <strong>October 28 - 29</strong><br />
                        ⏰Venue :
                        <strong>GCEK, Kannur</strong><br />
                        <br />
                        So don't miss out on this one...<br />
                    ...
                    <div className="clients__content">
                        <img className="icons" src={sbImage} alt="IEEE SB GCEK" id="sb-image"/>
            ...
            <section className="section">
                <div className="details_summary" data-animate-block >
                    <div className="stats_item" data-animate-el>
                        <div className="stats_count" data-counter="15"><span>15</span>K+</div>
                        <h5>Prizes</h5>
                    </div>
                    <div className="stats_item" data-animate-el>
                        <div className="stats_count" data-counter="10"><span>10</span></div>
                        <h5>Teams</h5>
                    </div>
                    <div className="stats_item" data-animate-el>
                        <div className="stats_count" data-counter="40"><span>40</span></div>
                        <h5>Participants</h5>
                    </div>
                    <div className="stats_item" data-animate-el>
                        <div className="stats_count" data-counter="24"><span>24</span></div>
                        <h5>Hours</h5>
                    </div>
                </div>
            </section>
            ...
            <section id="tracks" className="s-services target-section">
                ...
                <div className="services" data-animate-block >
                    <div className="service-item" data-animate-el>
                        <div className="service-icon-block">
                            <span className="service-icon">
                                <img className='service-image' src={productImage} alt='productImage' />
                            </span>
                        </div>
                    ...
                    <div className="service-item" data-animate-el>
                        <div className="service-icon-block">
                            <span className="service-icon">
                                <img className='service-image' src={frontendImage} alt='frontendImage' />
                            </span>
                        </div>
                        <div className="service-text">
                    ...
                    <div className="service-item" data-animate-el>
                        <div className="service-icon-block">
                            <span className="service-icon">
                                <img className='service-image' src={researchImage} alt='researchImage' />
                            </span>
                        </div>
                        <div className="service-text">
                    ...
                    <div className="service-item" data-animate-el>
                        <div className="service-icon-block">
                            <span className="service-icon">
                                <img className='service-image' src={ecommerceImage} alt='ecommerceImage' />
                            </span>
                        </div>
                        <div className="service-text">
            ...
            <section id="register">
                <div className='register-sub'>
                    ...
                    <div className="row row-x-center text-center s-contact__content">
                        <div className="column lg-12">
                            <p className="lead">
                                Submit your abstract here using given <a href="https://docs.google.com/document/d/1WG35M9bJKOdLgy0_rMWIA9RrIgNgIO8ZGILjHqU_e5U/edit?usp=drivesdk" target="_blank" rel='noreferrer'>
                                    format
                                </a>
                            </p>
                            <div>
                                <a className='dev-button-a' href='https://apply.devfolio.co/v2/sdk.js'>
                                    <div className='dev-button'>
                                        <button id="devfolio-apply-now"><svg className="dev-logo" xmlns="http://www.w3.org/2000/svg" fill="#fff"viewBox="0 0 115.46 123.46"><path d="M115.46 68a55.43 55.43 0 0 1-50.85 55.11S28.12 124 16 123a12.6 12.6 0 0 1-10.09-7.5 15.85 15.85 0 0 0 5.36 1.5c4 .34 10.72.51 20.13.51 13.82 0 28.84-.38 29-.38h.26a60.14 60.14 0 0 0 54.72-52.47c.05 1.05.08 2.18.08 3.34z" /><path d="M110.93 55.87A55.43 55.43 0 0 1 60.08 111s-36.48.92-48.58-.12C5 110.29.15 104.22 0 97.52l.2-83.84C.38 7 5.26.94 11.76.41c12.11-1 48.59.12 48.59.12a55.41 55.41 0 0 1 50.58 55.34z"/></svg>Apply with Devfolio</button>
                ...
                <div className='sponsor-logos'>
                        ...
                        <div className='s-container'>
                                <div className="sponsor-icon-block">
                                    <span className="s-logo-icon">
                                        <img id='polygon-image' className='icons-sponsor' src={polygonImage} alt="Polygon"/>
                                    </span>
                                </div>
                    ...
                    <a href="https://replit.com/">
                        <div className='s-container'>
                                <div className="sponsor-icon-block">
                                    <span className="s-logo-icon">
                                        <img id='replit-image' className='icons-sponsor' src={replitImage} alt="Replit"/>
                                    </span>
                                </div> 
                                <div className='s-text'>
                                    <p>replit</p>
                    ...
                    <div className="contact-all">
                        <div className="contact-el">
                            ...
                            <a href="https:/ieeesbgcek.org">
                                <img id="sb-image" className='icons-contact'
                                src={sbImage}
                                alt="IEEE SB GCEK"
                                />
                            </a>
                            ...
                            <a href="https://www.linkedin.com/in/mulearn-gcek/">
                                <img className='icons-contact'
                                src={mulearnImage}
                                alt="Mulearn GCEK"
                                />
                            </a>
                            <a href="https:/ieeesbgcek.org">
                                <img className='icons-contact' src={csImage} alt="IEEE CS SBC GCEK" />
                            </a>
                        </div>
                            ...
                            <ul className="contact-list">
                                <li>
                                    <a href="https://www.instagram.com/ieeesbgcek/">
                                        <img className='insta-logo' src={instaImage} alt='Instagram-logo' />
                                        ieeesbgcek
                                    </a>
                                </li>
                                <li>
                        ...
                        <div className="contact-el">
                            ...
                            <ul className="contact-list">
                                ...
                                <li><a href="tel:920-704-5811">+919207045811</a></li>
                                <li><a href="tel:999-517-4109">+919995174109</a></li>
                            </ul>
                        </div>
                    </div>
            </footer>
